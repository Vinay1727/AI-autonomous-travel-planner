...
class EmailSender:
    ...
    def send_otp_email(self, to_email, otp, user_name="User"):
        ...
        try:
            ...
            message["Subject"] = "LuxeTravel - Verify Your Email"
            message["From"] = f"LuxeTravel <{self.email_user}>"
            message["To"] = to_email
                ...
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p style="color: rgba(255, 255, 255, 0.8); line-height: 1.6;">
                            Thank you for joining LuxeTravel! To complete your registration and start planning your dream journeys, 
                    ...
                    <div class="footer">
                        <p style="margin: 0 0 10px 0;">
                            Need help? Contact us at <a href="mailto:support@luxetravel.ai" class="footer-link">support@luxetravel.ai</a>
                        </p>
    ...
    def send_welcome_email(self, to_email, user_name):
        ...
        try:
            message = MIMEMultipart("alternative")
            message["Subject"] = "Welcome to LuxeTravel! 🎉"
            message["From"] = f"LuxeTravel <{self.email_user}>"
            message["To"] = to_email
            ...
            <body style="font-family: Arial, sans-serif; background: #f5f5f5; padding: 20px;">
                <div style="max-width: 600px; margin: 0 auto; background: white; border-radius: 10px; padding: 40px;">
                    <h1 style="color: #d4af37;">Welcome to LuxeTravel, {user_name}! ✈️</h1>
