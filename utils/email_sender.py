...
class EmailSender:
    ...
    def send_otp_email(self, to_email, otp, user_name="User"):
        ...
        try:
            ...
            message["Subject"] = "Safar Chaska - Verify Your Email"
            message["From"] = f"Safar Chaska <{self.email_user}>"
            message["To"] = to_email
            ...
            <body>
                <div class="container">
                        ...
                        <h1>Safar Chaska</h1>
                        <p style="color: rgba(255, 255, 255, 0.7); margin: 0;">Safar Chaska Planning</p>
                    </div>
                    
                    <div class="content">
                        <p class="greeting">Hello {user_name},</p>
                        <p style="color: rgba(255, 255, 255, 0.8); line-height: 1.6;">
                            Thank you for joining Safar Chaska! To complete your registration and start planning your dream journeys,
                    ...
                    <div class="footer">
                        ...
                        <p style="margin: 0; font-size: 12px;">
                            © 2024 Safar Chaska. All rights reserved.
                        </p>
                    </div>
                </div>
            </body>
    ...
    def send_welcome_email(self, to_email, user_name):
        ...
        try:
            message = MIMEMultipart("alternative")
            message["Subject"] = "Welcome to Safar Chaska! 🎉"
            message["From"] = f"Safar Chaska <{self.email_user}>"
            message["To"] = to_email
            ...
            <body style="font-family: Arial, sans-serif; background: #f5f5f5; padding: 20px;">
                <div style="max-width: 600px; margin: 0 auto; background: white; border-radius: 10px; padding: 40px;">
                    <h1 style="color: #d4af37;">Welcome to Safar Chaska, {user_name}! ✈️</h1>
